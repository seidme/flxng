...
@Component({
    ...
    template: `
            <flx-treetable [data]="testData" [resizeMode]="'expand'" [reorderable]="true" [saveSettings]="true" [settingsStorageKey]="'test-treetable-settings'" [supportMdl]="true" id="test-treetable">
                ...
                <ng-template flxTemplate="rowExpansion" let-rowData="rowData" let-ri="rowIndex" let-pCols="columns" let-pColsMap="columnsMap">
                    <flx-treetable [data]="rowData.children" [includeHead]="false">
...
describe('TreetableComponent (dtHostComponent) >> ', () => {
    ...
    describe('Without detecting changes >> ', () => {
        ...
        let dtComp: any; // TreetableComponent
        ...
        beforeEach(() => {
            dtComp = <TreetableComponent>hostCompFixture.debugElement.children[0].componentInstance;
        });
    ...
    describe('After detecting initial changes >> ', () => {
        ...
        describe('`handleColDragging` method >> ', () => {
            ...
            beforeEach(() => {
                ...
                headCellNodeList = dtComp.dtHeadRef.nativeElement.querySelectorAll('.cell');
            ...
            it('should clone dragged cell elem', async(() => {
                ...
                let newHeadCellNodeList = dtComp.dtHeadRef.nativeElement.querySelectorAll('.cell');
